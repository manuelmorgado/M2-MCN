...
Additionally, we introduce a term of decay for the particles in the states |ee> and |eg> ^ |ge>, meaning the loss of particles.
In this scenario the constrain of the trace of rho doesn't hold.
"""
